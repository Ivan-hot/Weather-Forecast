...
docker-compose up -d
```
База даних налаштована для роботи на порту 5441 (зіставлений з портом PostgreSQL за замовчуванням 5432 всередині контейнера). Підключитися до неї можна за допомогою облікових даних, вказаних у файлі docker-compose.yml
